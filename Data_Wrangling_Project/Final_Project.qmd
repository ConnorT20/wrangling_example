...
test_data = pd.read_csv('/Users/connortoomey/Desktop/Mod2 Data Wrangling/GitHub/Data_Wrangling_Project/Travel_Test.csv')
...
```{python}
train_data = pd.read_csv('/Users/connortoomey/Desktop/Mod2 Data Wrangling/GitHub/Data_Wrangling_Project/Travel_Train.csv')
...
I am going to make a scatterplot of the level of satisfaction based on Departure Delay by flight classes. This will be our basis for our questions and analysis of our Flights. Satisfation level being satisfied is our desired outcome.
